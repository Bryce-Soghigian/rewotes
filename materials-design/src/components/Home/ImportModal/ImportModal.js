...
const submitMaterial = () => {
    ...
    reader.onload = () => {
        ...
        dispatch({type:"importFile", payload:{fileName:fileState.name, fileContent: reader.result}})
        setFileState(null)
...
const closeModal = () => {
    ...
    if(state.showImportModal === true){
        return (
            ...
            <input className="input-file" type="file" name="import" onChange={handleFileChange}/>
            <div className="start">
